...
issue](https://github.com/cisagov/ansible-role-persist-journald/issues)
...
request](https://github.com/cisagov/ansible-role-persist-journald/pulls),
...
```console
cd ansible-role-persist-journald
pyenv virtualenv <python_version_to_use> ansible-role-persist-journald
pyenv local ansible-role-persist-journald
